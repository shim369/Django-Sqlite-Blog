document.addEventListener('DOMContentLoaded', (event) => {
    ...
    function createBMITableView() {
        ...
        let bmiRanges = [
            { min: -Infinity, max: 16.00, description: 'Severe thinness' },
            { min: 16.00, max: 17.00, description: 'Moderate thinness' },
            { min: 17.00, max: 18.50, description: 'Mild thinness' },
            { min: 18.50, max: 25.00, description: 'Normal range' },
            { min: 25.00, max: 30.00, description: 'Pre-obese' },
            { min: 30.00, max: 35.00, description: 'Obese class1' },
            { min: 35.00, max: 40.00, description: 'Obese class2' },
